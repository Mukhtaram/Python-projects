...
service_rating = float(input('How good was the service of the wait staff, on a scale of 0 to 10? '))
quality_rating = float(input('How tasty was the food, on a scale of 0 to 10? '))
tipping.input['quality'] = quality_rating
tipping.input['service'] = service_rating
# Crunch the numbers
tipping.compute()
...
"""
print (f'The suggested tip is {tipping.output["tip"]}%.')
